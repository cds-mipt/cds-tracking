            ...
            for y in os.listdir(x_path):
                if y.endswith('.jpg'):
                    ...
                    if os.path.isfile(y_path):
                        # Create an image target directory for training
...
def gen_labels(xml_root, img_root, label_root, viz_root=None):
    """
    Parse xml (parse the results and visualize) + generate labels
    :param xml_root:
    :param img_root:
    :param label_root:
    :param viz_root:
    ...
    for x, y in zip(xml_f_paths, img_dirs):
        if os.path.isfile(x) and os.path.isdir(y):
            if x.endswith('.xml'):  # Found the original xml annotation file
                ...
                for frame in root.findall('frame'):
                    ...
                    if density != len(targets):  # Process every target in this frame
                    ...
                    # ----- Read a frame of the video seq, and blacken the corresponding region (the box under ignore_region)
                    ...
                    if not (viz_root is None):
                        # Image visualization directory and path
                        viz_path = viz_root + '/' + seq_name + '_' + os.path.split(img_path)[-1]

                        # Deep copy an img data as a visual output
                        img_viz = copy.deepcopy(img)

                    # Record each line of label_str of the frame (corresponding to a detection or tracking target)
                    frame_label_strs = []
                    ...
                    for target in targets:
                        ...
                        # Calculate the result of the visualization here
...
if __name__ == '__main__':
    preprocess(src_root='/home/josh94mur/Downloads/Insight-MVT_Annotation_Train',
               dst_root='/home/josh94mur/FairMOT_ws/Datasets/DETRAC')

    gen_labels(xml_root='/home/josh94mur/Downloads/DETRAC-Train-Annotations-XML',
               img_root='/home/josh94mur/FairMOT_ws/Datasets/DETRAC/images/train',
               label_root='/home/josh94mur/FairMOT_ws/Datasets/DETRAC/labels_with_ids/train',
               viz_root='/home/josh94mur/FairMOT_ws/FairMOTVehicle/viz_result')

    gen_dot_train_file(data_root='/home/josh94mur/FairMOT_ws/Datasets',
                       rel_path='/DETRAC/images/train',
                       out_root='/home/josh94mur/FairMOT_ws/FairMOTVehicle/src/data')

    clean_train_set(img_root='/home/josh94mur/FairMOT_ws/Datasets/DETRAC/images/train',
                    label_root='/home/josh94mur/FairMOT_ws/Datasets/DETRAC/labels_with_ids/train')

    count_files(img_root='/home/josh94mur/FairMOT_ws/Datasets/DETRAC/images/train',
                label_root='/home/josh94mur/FairMOT_ws/Datasets/DETRAC/labels_with_ids')
